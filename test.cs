...
namespace API
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // string urlStr = "/dwz/DWZCN0101810142YQ";
            ...
            // string urlstr = null;
            // string requestdata = "{\"tracking_number\": \"DWZCN0101810142YQ\",\"carrier_code\":\"dwz\",\"destination_code\":\"{destination_code}\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}";
            // string result = new Tracker().getOrderTracesByJson(requestdata, urlstr, "realtime");

            // 10 Modify courier code
            // string   urlStr =null;
            // string requestData="{\"tracking_number\": \"DWZCN0101810142YQ\",\"carrier_code\":\"dwz\",\"update_carrier_code\":\"china-ems\"}";
            ...
            // string   urlStr =null;
            // string requestData= "[{\"tracking_number\":\"DWZCN0101810142YQ\",\"carrier_code\":\"dwz\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"china-ems\"}]";
            ...
            // string   urlStr =null;
            // string requestData= "[{\"carrier_code\":\"dwz\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"}]";
